...
global.__filename = function filename(_0xca8036 = import.meta.url, _0x1b02cd = platform !== "win32") {
  if (_0x1b02cd) {
    if (/file:\/\/\//.test(_0xca8036)) {
      return fileURLToPath(_0xca8036);
    } else {
      return _0xca8036;
    }
  } else {
    return pathToFileURL(_0xca8036).toString();
  }
};
...
global.opts = new Object(_0x3ea7ac(process.argv.slice(2)).exitProcess(false).parse());
...
if (pairingCode && !conn.authState.creds.registered) {
  ...
  console.log(_0x3c5c92.bold.white("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"));
